...
void PcdReset(void);
void IC_CMT(unsigned char *UID,unsigned char *KEY,unsigned char RW,char *Dat);
...
//void IC_CMT(unsigned char *UID,unsigned char *KEY,unsigned char RW,char *Dat)
//{
//  unsigned char status = 0xab;
//  unsigned char qq[16]=0;//IC卡的类型
//  unsigned char IC_uid[16]=0;//IC卡的UID
//  
